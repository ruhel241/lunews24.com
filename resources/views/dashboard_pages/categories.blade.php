                  ...
                  <div class="x_content">
                    ...
                    <form action="{{route('AddNewCategory')}}" method="post">
                      ...
                      <input type="text" id="slug" class="form-control" name="slug" required />
                       ...
                       <br/> <button type="submit" class="btn btn-primary">Add New Category </button>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                       ...
                       <tr class="even pointer">
                          ...
                          <td class=" "> {{ $AllCategory->title }} </td>
                          <td class=" "> {{ $AllCategory->slug }} </td>
                          <td class=" ">{{ $AllCategory->created_at }} </td>
                          <td class=" last"><a href="{{route('EditCategory',$AllCategory->id)}}">Edit</a> / <a href="{{route('CategoryDelete', $AllCategory->id)}}">Delete</a> </td>
                        </tr>
