                  ...
                  <div class="x_content">
                    ...
                    <form action="{{Route('AddOrganization')}}" method="post">
                      ...
                      <input type="text" id="slug" class="form-control" name="slug" required />
                       ...
                       <br/> <button type="submit" class="btn btn-primary">Add New Organization </button>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      <thead>
                        <tr class="headings">
                          ...
                          <th class="column-title">Organization Categories </th>
                      ...
                      <tbody>
                       ...
                       <tr class="even pointer">
                          ...
                          <td class=" "> {{ $Organization->title }} </td>
                          <td class=" "> {{ $Organization->slug }} </td>
                          <td class=" ">{{ $Organization->created_at }} </td>
                          <td class=" last"><a href="{{route('EditOrganization',$Organization->id)}}">Edit</a> / <a href="{{route('DeleteOrganization', $Organization->id)}}">Delete</a> </td>
                        </tr>
